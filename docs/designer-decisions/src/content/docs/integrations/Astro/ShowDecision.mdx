...
In the following two examples we use the `<ShowDecision/>` to render both a [Color Value](/models/decision-types/color-value) decision and a [Size Scale](/models/decision-types/size-scale) decision.
