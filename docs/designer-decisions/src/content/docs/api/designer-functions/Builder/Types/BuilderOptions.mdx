---
title: BuilderOptions
slug: api/designer-functions/Builder/Types/BuilderOptions
sidebar:
    order: 0
---
...
The definition for the [built-in schemas](https://github.com/noodlestan/designer/blob/main/packages/libs/designer-schemas/src/constants.ts) are always loaded automatically.
...
See the examples in [buildStaticStore()](/api/designer-functions/Builder/buildStaticStore/#usage).
