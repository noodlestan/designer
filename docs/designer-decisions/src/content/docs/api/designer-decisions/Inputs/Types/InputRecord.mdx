---
title: InputRecord
slug: api/designer-decisions/Inputs/Types/InputRecord
sidebar:
    order: 0
---
...
#### ༶ `contexts`: string[] | [LookupContexts](/api/designer-decisions/Decisions/Types/LookupContexts)
