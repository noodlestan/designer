---
title: InputRecord
slug: api/designer-decisions/Types/Inputs/InputRecord
---
...
See [Decision Types](/models/decision-types) for the full list of decision types,
...
##### ༶ `contexts`: string[] | [LookupContexts](/api/designer-decisions/Types/Decisions/LookupContexts)
