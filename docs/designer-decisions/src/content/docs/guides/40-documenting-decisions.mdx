...
import { Aside, CardGrid, Code, FileTree, LinkCard } from '@astrojs/starlight/components';
import {
    FlexStack,
    FlexRow,
    ShowDecision,
...
API 🚧🚧 GetInvolved: Help appreciated: how to provide a package resolution default?
...
In this example we are using the [&lt;ShowDecision/&gt;](/components/Astro/ShowDecision/)
...
For instance, the [&lt;ShowDecisionCard/&gt;](/components/Astro/ShowDecisionCard/)
...
For instance, [Color Decisions](/components/Astro/color) components
...
For instance, [Space Decisions](/components/Astro/space) components
