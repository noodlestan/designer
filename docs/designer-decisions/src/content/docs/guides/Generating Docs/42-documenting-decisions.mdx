...
In this example we are using the [&lt;ShowDecision/&gt;](/integrations/Astro/ShowDecision/) component to render both a [ColorValueDecision](/decision-models/color-value) and a [ColorSetDecision](/decision-models/color-set).
