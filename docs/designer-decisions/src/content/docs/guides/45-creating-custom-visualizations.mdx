...
This guide explains how to create custom visualizations for design decisions for your documentation.
...
[Astro](https://docs.astro.build/en/getting-started/) website. Refer to the
[Rendering Decisions in Docs](/guides/documenting-design-decisions-with-astro-and-mdx) for
how to quickly setup a website similar to this one.
