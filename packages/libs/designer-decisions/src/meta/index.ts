import { ColorDecisionTypes, SizeDecisionTypes, TypeDecisionTypes } from './domains';
...
export const DECISION_TYPES = [...ColorDecisionTypes, ...SizeDecisionTypes, ...TypeDecisionTypes];
