import { D_OKLAB_LIGHTNESS_SCALE, D_OKLAB_LIGHTNESS_VALUE } from '../../../../../constants';
...
export const CHANNEL_DEFINITION: ColorChannelDefinition = {
    valueName: D_OKLAB_LIGHTNESS_VALUE,
    ...
    decisionTypes: {
        set: D_OKLAB_LIGHTNESS_SCALE,
        value: D_OKLAB_LIGHTNESS_VALUE,
    },
};
