...
describe('createSizeBaseValue()', () => {
    ...
    describe('Given a value', () => {
        ...
        it('should have the provided context', () => {
            const result = createSizeBaseValue(sizeDef, valueContext, input);

            expect(result.context()).toBe(valueContext);
        });

        it('should consume the input', () => {
            createSizeBaseValue(sizeDef, valueContext, input);
    ...
    describe('Given a quantize param', () => {
        ...
        it('should expose the quantized value via .get()', () => {
            const result = createSizeBaseValue(sizeDef, valueContext, input, { quantize: 0.02 });
