...
Provide a `string` with one of [ColorFormat](/api/designer-decisions/Types/ColorFormat/)
...
Provide an `array` of [ColorFormat](/api/designer-decisions/Types/ColorFormat/)
