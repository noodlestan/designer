...
const decision = store.decision('Green Foreground');
```
...
In this example we are using the [&lt;ShowDecision/&gt;](/components/decisions/show-decision/)
...
For instance, the [&lt;ShowDecisionCard/&gt;](/components/cards/show-decision-card/)
...
<CardGrid>
    <ShowDecisionCard d="Green Foreground" loader={decisionLoader} />
</CardGrid>
```

<ShowDecisionCard store={store} d="Curcuma Palette" />
...
[&lt;ShowColorValue/&gt;](/components/values/show-color-value) and the
[&lt;ShowDecisionUsage/&gt;](/components/decisions/show-decision-usage) atom
within the standard
[&lt;DecisionCard/&gt;](/components/layouts/decision-card) layout.
...
<DecisionCardLayout>
    ...
    <ShowColorValue slot="viz" store={store} d={decision} value={['rgb', 'hsl']} />
    <div slot="details">
        <h3>Usage</h3>
...
<MyColorDecision store={store} d="Green Foreground" />
```
