...
-   [ColorSetDecision`](/decisions/color-set)
...
See [Guides / Validating Decisions](/guides/validating-design-decisions-with-schemas/)
...
-   All decisions of type `color-set/*` produces a `ColorSetDecision` which exposes
...
See [Reference: Decision types](/decision-models) for a comprehensive list of decision models
...
In turn, the [color-value/explicit](/decision-models/color-value/explicit) decision model,
...
See [Reference / Decision types](/decision-models) for details on each specific model.
...
-   [Reference / Decision types](/decision-models)
